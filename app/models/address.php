...
class Address extends AppModel {
	...
	var $belongsTo = array('BusinessPartner', 'AddressType', 'Purchaser', 'ContactPerson');
	...
	var $full_name = 'TRIM(CONCAT(Address.person_last_name, " ", Address.person_first_name))';
	var $street_info = 'TRIM(CONCAT(Address.street, " ", Address.number))';
	var $one_line = 'TRIM(CONCAT(Address.street, " ", Address.number, ", ", Address.zip, " ", Address.city))';
