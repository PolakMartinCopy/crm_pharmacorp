...
<table class="top_heading">
	<tr>
		...
		<th><?php echo $this->Paginator->sort('Obchodní partner', 'BusinessPartner.name')?></th>
	...
	<tr<?php echo $odd?>>
		...
		<td><?php echo $this->Html->link($store['BusinessPartner']['name'], array('controller' => 'business_partners', 'action' => 'view', $store['BusinessPartner']['id']))?></td>
