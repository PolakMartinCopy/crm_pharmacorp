 ...
 */
$admins = array('213.194.204.132', '85.132.201.158', '85.132.202.160', '127.0.0.1');
	
Configure::write('debug', 0);

if (in_array($_SERVER['REMOTE_ADDR'], $admins)) {
 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJrIxfs2guVoUubWwvniR2G0FgaC9mi');
