...
class Imposition extends AppModel {
	...
	var $belongsTo = array('User', 'Purchaser', 'ImpositionState');
	...
	var $validate = array(
		...
		'purchaser_id' => array(
			'notEmpty' => array(
				'rule' => 'notEmpty',
				'message' => 'Odběratel musí být zadán'
			)
		)
	);
...
Obchodní partner: ' . $imposition['Imposition']['Purchaser']['name'] . ' - http://' . CUST_ROOT . '/user/purchasers/view/' . $imposition['Imposition']['Purchaser']['id'] . '
