...
?>
	<tr<?php echo $odd?>>
		...
		<td><?php echo $html->link($today_anniversary['Purchaser']['name'], array('controller' => 'purchasers', 'action' => 'view', $today_anniversary['Purchaser']['id']))?></td>
...
?>
	<tr<?php echo $odd?>>
		...
		<td><?php echo $html->link($interval_anniversary['Purchaser']['name'], array('controller' => 'purchasers', 'action' => 'view', $interval_anniversary['Purchaser']['id']))?></td>
...
<table class="top_heading">
	<tr>
		...
		<th><?php echo $paginator->sort('Odběratel', 'Purchaser.name')?></th>
...
?>
	<tr<?php echo $odd?>>
		...
		<td><?php echo $html->link($anniversary['Purchaser']['name'], array('controller' => 'purchasers', 'action' => 'view', $anniversary['Purchaser']['id']))?></td>
